...
function reportSummaryText(summary, selectedRegionOption) {
      ...
      <div className="grid g2">
        ...
        <div className="card">
          ...
          <div className="narrative-byline">
            {summary?.region ? formatRegionOption(selectedRegionOption) : 'Generated by Amazon Bedrock - Claude Sonnet 4'}
          </div>
        </div>
      </div>
    </>
